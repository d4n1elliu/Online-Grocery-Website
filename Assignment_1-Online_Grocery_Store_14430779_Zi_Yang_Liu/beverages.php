...
<header class="header">
    ...
    <form action="beverages.php" class="search-form" method="get">
...
<section class="product" id="products">
    <div class="item-list">
        ...
        $sql = "SELECT * FROM products WHERE product_id BETWEEN 4000 AND 4005";
        ...
        if ($result && $result->num_rows > 0) {
            while ($product = $result->fetch_assoc()) {
                ...
                // Category Filtering 
                $category = 'other';
                if (str_contains($productLower, 'instant coffee')) {
                    $category = 'coffee';
                }
                if (str_contains($productLower, 'earl grey tea bags')) {
                    $category = 'tea';
                }
                if (str_contains($productLower, 'chocolate bar')) {
                    $category = 'chocolate';
                }
        ...
        if (!empty($matched)) {
            ...
            echo "<p style='text-align:center;'>No beverage products found.</p>";
        }
        ?>
    </div>
</section>
